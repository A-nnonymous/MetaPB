...
public:
  ...
  OperatorMAP(std::unique_ptr<GLOBAL_DPU_MGR> &g_DPU_MGR) : OperatorBase(g_DPU_MGR) {}
  ...
  inline virtual void execCPU(const size_t batchSize_MiB,
    ...
    DPU_ASSERT(dpu_push_xfer(allDPUs, DPU_XFER_TO_DPU,
                             DPU_MRAM_HEAP_POINTER_NAME, 0, input_size_dpu,
                             DPU_XFER_DEFAULT));
  }
  inline virtual void
